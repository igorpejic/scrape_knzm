...
i = 1
browser.get('http://online.konzum.hr/#!/categories/60005258/sve-za-dom?show=all&sort_field=name&sort=nameAsc&max_price=300&page=1&per_page={0}'.format(items['kucni-ljubimci']))
